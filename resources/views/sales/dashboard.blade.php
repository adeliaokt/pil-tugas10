        ...
        <div class="content-body">
            ...
            <section id="dashboard-ecommerce">
                <div class="row justify-content-center mb-1">
                    <button class="btn btn-primary btn-icon round" data-toggle="modal" data-target="#filter"><i data-feather="filter"></i> <span class="align-middle d-sm-inline-block d-none">Filter</span></button>
                </div>
                <div class="card">
                ...
                <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                    ...
                    <div class="action-tags">
                        <div class="form-group">
                            ...
                            <input type="date" id="todoTitleAdd" name="dari" class="new-todo-item-title form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="todoTitleAdd" class="form-label">Ke tanggal</label>
                            <input type="date" id="todoTitleAdd" name="ke" class="new-todo-item-title form-control" required>
                        </div>
